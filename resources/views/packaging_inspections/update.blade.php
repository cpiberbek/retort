    ...
    <div class="card shadow-sm border-0">
        <div class="card-body p-4 p-md-5">
            ...
            <h4 class="mb-1">
                ...
                Lengkapi Pemeriksaan Packaging #{{ $packagingInspection->id }}
            </h4>

            <p class="text-muted mb-4">
                Silakan lengkapi data yang masih kosong. Data yang sudah terisi tidak dapat diubah.
            </p>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input
                                    ...
                                    {{ $packagingInspection->inspection_date ? 'readonly' : '' }}
                                    required
                                >
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input
                                    ...
                                    {{ $packagingInspection->shift ? 'readonly' : '' }}
                                    required
                                >
                            </div>
                        </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function renderDetailForm(data = null) {
            ...
            const lockSupplier = isLocked(supplier);
                ...
                checksHtml += `
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="btn-group btn-check-group w-100" role="group">
                            ...
                            <button
                                type="button"
                                class="btn ${val === 'OK' ? 'btn-success' : 'btn-outline-secondary'} w-50 ${isItemLocked ? 'disabled' : ''}"
                                data-value="OK"
                            ...
                            <button
                                type="button"
                                class="btn ${val === 'Not OK' ? 'btn-danger' : 'btn-outline-secondary'} w-50 ${isItemLocked ? 'disabled' : ''}"
                                data-value="Not OK"
                                data-target-input="#${item.key}_${i}"
                            >
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input
                            ...
                            ${getReadonlyAttr(packaging_type)}
                            required
                        >
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        ${lockSupplier
                            ? `<input type="hidden" name="items[${i}][supplier]" value="${supplier}">`
                            : ''
                        }
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        ${lockAccept
                            ? `<input type="hidden" name="items[${i}][acceptance_status]" value="${accept_val}">`
                            : ''
                        }
                    </div>
                    ...
                    <div class="col-md-5">
                        ...
                        ${lockVehicle
                            ? `<input type="hidden" name="items[${i}][vehicle_condition]" value="${vehicle_cond}">`
                            : ''
                        }
                    </div>
