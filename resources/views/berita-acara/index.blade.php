...
@section('content')
    <div class="container-fluid py-0">
        ...
        <form id="filterForm" method="GET" action="{{ route('berita-acara.index') }}"
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input type="text" name="nomor_ba" id="nomor_ba"
                            class="form-control border-start-0 ps-0 shadow-none filter-input" placeholder="Cari Nomor BA..."
                            ...
                            @forelse ($beritaAcaras as $item)
                                <tr>
                                    ...
                                    <td class="align-middle text-primary">
                                        {{ $item->nomor }}
                                        <span class="badge bg-light text-primary border ms-1 copy-badge"
                                            style="cursor:pointer" data-text="{{ $item->nomor }}" title="Copy">
                                    ...
                                    <td class="text-center">
                                        ...
                                        @else
                                            <span class="badge-status status-revision"><i
                                                    class="bi bi-x-circle me-1"></i>Revisi</span>
                                        @endif
                                    </td>
                                    ...
                                    <td class="text-center align-middle text-nowrap">
                                        <div class="d-flex justify-content-center align-items-center">
                                            ...
                                            @can('can access detail button')
                                                {{-- 1. Detail --}}
                                                <a href="{{ route('berita-acara.show', $item->id) }}"
                                            ...
                                            @can('can access edit button')
                                                {{-- 2. Edit --}}
                                                <a href="{{ route('berita-acara.edit', $item->id) }}"
                            ...
                            @empty
                                <tr>
                                    <td colspan="8" class="text-center py-5 text-muted">
                                        ...
                                        <p class="small mb-0">Silakan tambahkan data baru atau ubah kata kunci pencarian.
                                        </p>
                                    </td>
                                </tr>
                            @endforelse
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Silakan pilih <b>Tanggal & No BA</b> yang spesifik di bagian filter terlebih dahulu sebelum melakukan
                    export.
                </div>
...
--}}
    @foreach ($beritaAcaras as $item)
        <div class="modal fade modal-verification" id="verifyModal{{ $item->id }}" tabindex="-1"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="status_spv" id="status_spv_{{ $item->id }}"
                                    ...
                                    <option value="1" {{ $current != 2 ? 'selected' : '' }} style="color: #198754;">
                                        ✅ Verified (Disetujui)</option>
                                    <option value="2" {{ $current == 2 ? 'selected' : '' }} style="color: #dc3545;">
                                        ❌ Revision (Perlu Perbaikan)</option>
                                </select>
                            </div>

                            <div class="mb-3">
                                <label for="catatan_spv_{{ $item->id }}" class="form-label fw-bold">Catatan
                                    Verifikasi (Wajib jika 'Revision')</label>
                                <textarea name="catatan_spv" id="catatan_spv_{{ $item->id }}" rows="4"
                                    class="form-control shadow-none textarea-custom" placeholder="Tuliskan catatan perbaikan...">{{ old('catatan_spv', $item->catatan_spv) }}</textarea>
                            </div>
                        </div>
