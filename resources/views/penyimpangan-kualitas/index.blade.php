...
@section('content')
    <div class="container-fluid py-0">
        ...
        <div class="d-sm-flex justify-content-between align-items-center mb-4">
            ...
            <div class="btn-group" role="group">
                ...
                @can('can access export')
                    <a href="{{ route('penyimpangan-kualitas.exportPdf', ['date' => request('date')]) }}" target="_blank"
        ...
        <form id="filterForm" method="GET" action="{{ route('penyimpangan-kualitas.index') }}"
                                        ...
                                        <div class="d-flex justify-content-center align-items-center gap-2">
                                            ...
                                            @can('can access update button')
                                                ...
                                                <a href="{{ route('penyimpangan-kualitas.update_form', $item->id) }}"
                                                    class="btn btn-success btn-sm" title="Update / Lengkapi Data">
