...
@section('content')
    <div class="container-fluid py-0">
        ...
        <form id="filterForm" method="GET" action="{{ route('inspections.index') }}"
                            ...
                            @forelse ($inspections as $item)
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        {{ $item->setup_kedatangan ? \Carbon\Carbon::parse($item->setup_kedatangan)->format('d-m-Y') : '-' }}
                                        <br>
                                    ...
                                    <td class="text-center align-middle">
                                        <div class="d-flex justify-content-center align-items-center">
                                            ...
                                            {{-- 2. Detail --}}
                                            <a href="{{ route('inspections.show', $item->uuid) }}"
                                            ...
                                            @can('can access edit button')
                                                <a href="{{ route('inspections.edit', $item->uuid) }}"
                                            ...
                                            @can('can access update button')
                                                <a href="{{ route('inspections.form_update', $item->uuid) }}"
                                            ...
                                            @can('can access delete button')
                                                <form action="{{ route('inspections.destroy', $item->uuid) }}" method="POST"
                                                    class="d-inline"
                    ...
                    <form action="{{ route('inspections.verify', $item->uuid) }}" method="POST">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title fw-bolder fs-4 text-uppercase"
                                id="verifyModalLabel{{ $item->uuid }}"><i class="bi bi-gear-fill me-2"></i>Verification
                            </h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="status_spv" id="status_spv_{{ $item->uuid }}"
                                    ...
                                    <option value="1"
                                        {{ old('status_spv', $item->status_spv) != 2 ? 'selected' : '' }}
                            ...
                            <div class="mb-3">
                                <label for="catatan_spv_{{ $item->uuid }}" class="form-label fw-bold">Catatan
