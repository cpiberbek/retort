...
@section('content')
    <div class="page-container">
        ...
        <div class="page-header">
            <h1><i class="bi bi-magnet-fill" style="color: var(--color-primary);"></i> Detail Pemeriksaan Kekuatan Magnet Trap
            </h1>
        ...
        <div class="detail-card">
            ...
            <div class="detail-grid mb-3">
                ...
                {{-- Magnet 1 --}}
                <div class="detail-grid-item">
                    <strong>Magnet 1:</strong>
                    <span>
                        {{ $pemeriksaanKekuatanMagnetTrap->kekuatan_median_1 !== null
                            ? number_format($pemeriksaanKekuatanMagnetTrap->kekuatan_median_1, 2) . ' G'
                            : '-' }}
                    </span>
                </div>
                ...
                {{-- Magnet 2 --}}
                <div class="detail-grid-item">
                    <strong>Magnet 2:</strong>
                    <span>
                        {{ $pemeriksaanKekuatanMagnetTrap->kekuatan_median_2 !== null
                            ? number_format($pemeriksaanKekuatanMagnetTrap->kekuatan_median_2, 2) . ' G'
                            : '-' }}
                    </span>
                </div>
                ...
                {{-- Magnet 3 --}}
                <div class="detail-grid-item">
                    <strong>Magnet 3:</strong>
                    <span>
                        {{ $pemeriksaanKekuatanMagnetTrap->kekuatan_median_3 !== null
                            ? number_format($pemeriksaanKekuatanMagnetTrap->kekuatan_median_3, 2) . ' G'
                            : '-' }}
                    </span>
                </div>

                {{-- Magnet 4: tampil jika ada --}}
                @if ($pemeriksaanKekuatanMagnetTrap->kekuatan_median_4 !== null)
                    <div class="detail-grid-item">
                        <strong>Magnet 4:</strong>
                        <span>
                            {{ number_format($pemeriksaanKekuatanMagnetTrap->kekuatan_median_4, 2) }} G
                        </span>
                    </div>
                @endif

                {{-- Magnet 5: tampil jika ada --}}
                @if ($pemeriksaanKekuatanMagnetTrap->kekuatan_median_5 !== null)
                    <div class="detail-grid-item">
                        <strong>Magnet 5:</strong>
                        <span>
                            {{ number_format($pemeriksaanKekuatanMagnetTrap->kekuatan_median_5, 2) }} G
                        </span>
                    </div>
                @endif

                {{-- Magnet 6: tampil jika ada --}}
                @if ($pemeriksaanKekuatanMagnetTrap->kekuatan_median_6 !== null)
                    <div class="detail-grid-item">
                        <strong>Magnet 6:</strong>
                        <span>
                            {{ number_format($pemeriksaanKekuatanMagnetTrap->kekuatan_median_6, 2) }} G
                        </span>
                    </div>
                @endif
            ...
            <h4 style="margin-top: 1.5rem; margin-bottom: 0.5rem; font-weight: 600; font-size: 1.1rem;">Parameter Setingan:
            </h4>
            <div>
                {{-- Variabel diubah --}}
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="detail-grid-item">
                        ...
                        <span>
                            {{-- Variabel diubah --}}
                            @if ($pemeriksaanKekuatanMagnetTrap->status_spv == 0)
                                <span class="badge bg-warning text-dark">Pending</span>
                            @elseif($pemeriksaanKekuatanMagnetTrap->status_spv == 1)
                    ...
                    <div class="detail-grid-item">
                        ...
                        <span>{{ $pemeriksaanKekuatanMagnetTrap->verified_at ? $pemeriksaanKekuatanMagnetTrap->verified_at->format('d M Y, H:i') : '-' }}</span>
                    </div>
        ...
        <div class="detail-card">
            ...
            <div class="card-footer bg-light text-muted"
                style="margin: 1.5rem -1.5rem -1.5rem; border-top: 1px solid var(--color-gray);">
                <div class="d-flex justify-content-between flex-wrap small p-3">
                    ...
                    <span><strong>Dibuat Pada:</strong>
                        {{ $pemeriksaanKekuatanMagnetTrap->created_at->format('d M Y, H:i') }}</span>
                    <span><strong>Diperbarui:</strong>
                        {{ $pemeriksaanKekuatanMagnetTrap->updated_at->format('d M Y, H:i') }}</span>
                </div>
            </div>
        </div>
    </div>
