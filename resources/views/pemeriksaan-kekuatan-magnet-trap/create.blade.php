...
@section('content')
            ...
            <div class="card-body p-4 p-md-5">
                ...
                <form action="{{ route('pemeriksaan-kekuatan-magnet-trap.store') }}" method="POST">
                            ...
                            <div class="row g-3 mb-3" id="magnetContainer">
                                ...
                                <div class="col-md-4 magnet-field" data-magnet="3">
                                    ...
                                    <input type="number" step="0.01" name="kekuatan_median_3" id="kekuatan_median_3"
                                        ...
                                        value="{{ old('kekuatan_median_3') }}">
                                </div>

                                {{-- Magnet 4 --}}
                                <div class="col-md-4 magnet-field d-none" data-magnet="4">
                                    ...
                                    <input type="number" step="0.01" name="kekuatan_median_4" id="kekuatan_median_4"
                                        ...
                                        value="{{ old('kekuatan_median_4') }}">
                                </div>

                                {{-- Magnet 5 --}}
                                <div class="col-md-4 magnet-field d-none" data-magnet="5">
                                    ...
                                    <input type="number" step="0.01" name="kekuatan_median_5" id="kekuatan_median_5"
                                        ...
                                        value="{{ old('kekuatan_median_5') }}">
                                </div>

                                {{-- Magnet 6 --}}
                                <div class="col-md-4 magnet-field d-none" data-magnet="6">
                            ...
                            <div class="card p-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="parameter_sesuai"
                                        ...
                                        {{ old('parameter_sesuai', '1') == '1' ? 'checked' : '' }} required>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="parameter_sesuai"
                                        ...
                                        {{ old('parameter_sesuai') == '0' ? 'checked' : '' }} required>
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        <button type="submit" class="btn btn-primary btn-lg"><i class="bi bi-save"></i> Simpan
                            Data</button>
                        {{-- Route name diubah --}}
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // ==========================================
            // CEK OLD VALUE SAAT VALIDATION ERROR
            // ==========================================
            for (let i = 4; i <= 6; i++) {

                const input = document.getElementById(`kekuatan_median_${i}`);
            ...
            btnHapus.addEventListener('click', function() {
                ...
                if (magnet) {
                    ...
                    // Bersihkan nilai sebelum disembunyikan
                    if (input) {
                        input.value = '';
                    }
