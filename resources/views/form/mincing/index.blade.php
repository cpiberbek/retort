        ...
        <form id="filterForm" method="GET" action="{{ route('mincing.index') }}"
            ...
            <div class="row">
                ...
                <div class="col-md-3 align-self-end">
                    ...
                    <a href="{{ route('mincing.index') }}" class="btn btn-primary mb-2"><i
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                ...
                exportPdfBtn.addEventListener('click', function() {
                    ...
                    const exportUrl = "{{ route('mincing.exportPdf') }}?" + new URLSearchParams(formData)
                        .toString();
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        @if ($dep)
                                            ...
                                            <div class="modal fade" id="mincingModal{{ $dep->uuid }}" tabindex="-1"
                                                aria-labelledby="mincingModalLabel{{ $dep->uuid }}" aria-hidden="true">
                                                            ...
                                                            <table
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr class="section-header bg-light fw-bold">
                                                                        <td class="text-left">Bahan Baku dan Bahan Tambahan
                                                                            (Non-Premix)
                                                                        </td>
                                                                        <td>Kode</td>
                                                                        <td>(°C)</td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="5">
                                                                            {{ $dep->suhu_akhir_mixing ?? '-' }}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="text-left">Suhu Akhir Emulsifying</td>
                                                                        <td colspan="5">
                                                                            {{ $dep->suhu_akhir_emulsi ?? '-' }}</td>
                                                                    </tr>
                                    ...
                                    <td class="text-center align-middle">
                                        ...
                                        @elseif ($dep->status_produksi == 1)
                                            ...
                                            <a href="javascript:void(0);" data-bs-toggle="modal"
                                                ...
                                                style="cursor: pointer; font-weight: bold;">Checked</a>

                                            <!-- Modal -->
                                            <div class="modal fade" id="checkedModal{{ $dep->uuid }}" tabindex="-1"
                                                aria-labelledby="checkedModalLabel{{ $dep->uuid }}"
                                                aria-hidden="true">
