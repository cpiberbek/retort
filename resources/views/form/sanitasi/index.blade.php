                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        @if (!empty($dep->pemeriksaan))
                                            ...
                                            <div class="modal fade" id="pemeriksaanModal{{ $dep->uuid }}" tabindex="-1"
                                                aria-labelledby="pemeriksaanModalLabel{{ $dep->uuid }}"
                                                aria-hidden="true">
                                                <div
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header bg-primary text-white">
                                                            <h5 class="modal-title"
                                                                id="pemeriksaanModalLabel{{ $dep->uuid }}">
                                                                    ...
                                                                    <tbody>
                                                                        @foreach ($pemeriksaan as $bagian => $item)
                                                                            <tr>
                                                                                ...
                                                                                <td>{{ $item['tindakan'] ?? '-' }}</td>
                                                                                <td>{{ $item['waktu_koreksi'] ?? '-' }}
                                                                                </td>
                                                                                <td>{{ $item['dikerjakan_oleh'] ?? '-' }}
                                                                                </td>
                                                                                <td>{{ $item['waktu_verifikasi'] ?? '-' }}
                                                                                </td>
                                                                            </tr>
                                                                        @endforeach
                                                                    </tbody>
                                    ...
                                    <td class="text-center align-middle">
                                        ...
                                        @can('can access edit button')
                                            <a href="{{ route('sanitasi.edit.form', $dep->uuid) }}"
                                                class="btn btn-warning btn-sm me-1">
                                                <i class="bi bi-pencil-square"></i> Edit
                                            </a>
                                        @endcan
                                        @can('can access update button')
                                            <a href="{{ route('sanitasi.update.form', $dep->uuid) }}"
                                                class="btn btn-info btn-sm me-1">
                                                <i class="bi bi-pencil"></i> Update
                                            </a>
                                        @endcan
                                        @can('can access delete button')
                                            <form action="{{ route('sanitasi.destroy', $dep->uuid) }}" method="POST"
                                                class="d-inline">
                                                @csrf
                                                @method('DELETE')
                                        ...
                                        <div class="modal fade" id="verifyModal{{ $dep->uuid }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered modal-md">
                                                <form action="{{ route('sanitasi.verification.update', $dep->uuid) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PUT')
