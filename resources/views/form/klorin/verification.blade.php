...
<div class="container-fluid py-0">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <form id="filterForm" method="GET" action="{{ route('klorin.verification') }}" class="d-flex flex-wrap align-items-center gap-5 MB-3 p-2 border rounded bg-light shadow-sm">
