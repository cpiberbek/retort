...
@section('content')
    <div class="container-fluid py-0">
        ...
        {{-- Filter Form --}}
        <form id="filterForm" method="GET" action="{{ route('wire.index') }}"
            ...
            document.addEventListener('DOMContentLoaded', () => {
                ...
                if (exportPdfBtn) {
                    exportPdfBtn.addEventListener('click', function() {
                        ...
                        const exportUrl = "{{ route('wire.exportPdf') }}?" + new URLSearchParams(formData)
                            .toString();
                        ...
                        <tbody>
                            ...
                            @forelse ($data as $dep)
                                <tr>
                                    ...
                                    <td>{{ \Carbon\Carbon::parse($dep->date)->format('d-m-Y') }} | {{ $dep->shift }}
                                    </td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        @if (!empty($data_wire))
                                            ...
                                            <div class="modal fade" id="wireModal{{ $dep->uuid }}" tabindex="-1"
                                                aria-hidden="true">
                                                        ...
                                                        <div class="modal-body text-start">
                                                            @foreach ($data_wire as $mIndex => $mesin)
                                                                <div class="mb-3 border-bottom pb-3">
                                                                    <h6 class="fw-bold text-primary">🧭 Mesin:
                                                                        {{ $mesin['mesin'] ?? '-' }}</h6>
                                                                    <table
