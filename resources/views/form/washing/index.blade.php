            ...
            document.addEventListener('DOMContentLoaded', () => {
                ...
                if (exportPdfBtn) {
                    exportPdfBtn.addEventListener('click', function() {
                        ...
                        const exportUrl = "{{ route('washing.exportPdf') }}?" + new URLSearchParams(formData)
                            .toString();
                        ...
                        <tbody>
                            ...
                            @forelse ($data as $dep)
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        {{ $dep->mincing->kode_produksi ?? $dep->kode_produksi }}</td>
                                    <td class="text-center align-middle">
                                        {{ \Carbon\Carbon::parse($dep->pukul)->format('H:i') }}</td>
                                            ...
                                            <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                                <div class="modal-content">
                                                    <div class="modal-header bg-primary text-white">
                                                        <h5 class="modal-title" id="detailModalLabel{{ $dep->uuid }}">
                                                            Detail Pemeriksaan Washing - Drying</h5>
                                                    ...
                                                    <div class="modal-body text-start">
                                                        ...
                                                        <table class="table table-bordered table-sm mb-3">
                                                            <tbody>
                                                                <tr>
                                                                    <th style="width: 50%;">Nama Varian</th>
                                                                    <td>{{ $dep->nama_produk }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th>Kode Batch</th>
                                                                    <td>{{ $dep->mincing->kode_produksi ?? $dep->kode_produksi }}
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        ...
                                                        {{-- PENGECEKAN --}}
                                                        <h6 class="text-primary fw-bold mt-2"><i
                                                                class="bi bi-check2-square me-1"></i> Pengecekan</h6>
                                                        <table class="table table-bordered table-sm mb-3">
                                                            <tbody>
                                                                <tr>
                                                                    <th style="width: 50%;">Panjang Varian Akhir (Cm)</th>
                                                                    <td>{{ $dep->panjang_produk ?? '-' }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th>Diameter Varian Akhir (Mm)</th>
                                                                    <td>{{ $dep->diameter_produk ?? '-' }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th>Airtrap</th>
                                                                    <td>{{ $dep->airtrap ?? '-' }}</td>
                                                                ...
                                                                <tr>
                                                                    <th>Sisa Adonan</th>
                                                                    <td>{{ $dep->sisa_adonan ?? '-' }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th>Kekuatan Seal</th>
                                                                    <td>{{ $dep->kekuatan_seal ?? '-' }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th>Print Kode Batch</th>
                                                                    <td>{{ $dep->print_kode ?? '-' }}</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        ...
                                                        <table class="table table-bordered table-sm mb-3">
                                                            <tbody>
                                                                <tr>
                                                                    <th style="width: 50%;">Konsentrasi PC Kleer 1 (%)</th>
                                                                    <td>{{ $dep->konsentrasi_pckleer ?? '-' }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th>Suhu PC Kleer 1 (°C)</th>
                                                                    <td>{{ $dep->suhu_pckleer_1 ?? '-' }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th>Suhu PC Kleer 2 (°C)</th>
                                                                    <td>{{ $dep->suhu_pckleer_2 ?? '-' }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th>pH PC Kleer</th>
                                                                    <td>{{ $dep->ph_pckleer ?? '-' }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th>Kondisi Air PC Kleer</th>
                                                                    <td>{{ $dep->kondisi_air_pckleer ?? '-' }}</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        ...
                                                        <table class="table table-bordered table-sm mb-3">
                                                            <tbody>
                                                                <tr>
                                                                    <th style="width: 50%;">Konsentrasi Pottasium Sorbate
                                                                        (%)
                                                                    </th>
                                                                    <td>{{ $dep->konsentrasi_pottasium ?? '-' }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th>Suhu Pottasium Sorbate (°C)</th>
                                                                    <td>{{ $dep->suhu_pottasium ?? '-' }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th>pH Pottasium Sorbate</th>
                                                                    <td>{{ $dep->ph_pottasium ?? '-' }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th>Kondisi Air Pottasium Sorbate</th>
                                                                    <td>{{ $dep->kondisi_pottasium ?? '-' }}</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        ...
                                                        {{-- SUHU & SPEED --}}
                                                        <h6 class="text-primary fw-bold mt-2"><i
                                                                class="bi bi-speedometer2 me-1"></i> Suhu & Speed Conveyor
                                                        </h6>
                                                        <table class="table table-bordered table-sm mb-3">
                                                            <tbody>
                                                                <tr>
                                                                    <th style="width: 50%;">Suhu Heater (°C)</th>
                                                                    <td>{{ $dep->suhu_heater ?? '-' }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th>Speed Conv. Drying 1</th>
                                                                    <td>{{ $dep->speed_1 ?? '-' }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th>Speed Conv. Drying 2</th>
                                                                    <td>{{ $dep->speed_2 ?? '-' }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th>Speed Conv. Drying 3</th>
                                                                    <td>{{ $dep->speed_3 ?? '-' }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <th>Speed Conv. Drying 4</th>
                                                                    <td>{{ $dep->speed_4 ?? '-' }}</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
