    ...
    <div class="container-fluid py-0">
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <form id="filterForm" method="GET" action="{{ route('recall.index') }}"
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        ...
                                        @can('can access delete button')
                                            <form action="{{ route('recall.destroy', $dep->uuid) }}" method="POST"
                                                class="d-inline">
                                                @csrf
                                                @method('DELETE')
                                        ...
                                        <div class="modal fade" id="verifyModal{{ $dep->uuid }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered modal-md">
                                                <form action="{{ route('recall.updateVerification', $dep->uuid) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PUT')
                                    ...
                                    {{ $dep->catatan_spv }}</textarea>
                                        ...
                                        <div class="modal fade" id="verifyManagerModal{{ $dep->uuid }}"
                                            ...
                                            aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered modal-md">
                                                <form action="{{ route('recall.updateApproval', $dep->uuid) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PUT')
