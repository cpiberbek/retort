                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="date" name="date" id="dateInput" class="form-control"
                                        value="{{ old('date', $prepacking->date) }}" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <select name="nama_produk" id="nama_produk" class="form-control selectpicker"
                                        ...
                                        @foreach ($produks as $produk)
                                            <option value="{{ $produk->nama_produk }}"
                                                {{ old('nama_produk', $prepacking->nama_produk) == $produk->nama_produk ? 'selected' : '' }}>
                                                {{ $produk->nama_produk }}
                                            </option>
                                        @endforeach
                                    </select>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="conveyor" id="conveyor"
                                                    ...
                                                    value="{{ old('conveyor', $prepacking->conveyor) }}">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" name="suhu_produk[suhu_1]" id="suhu_1"
                                                    ...
                                                    value="{{ old('suhu_produk.suhu_1', $suhuData['suhu_1'] ?? '') }}"
                                                    min="0">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <input type="number" name="suhu_produk[suhu_2]" id="suhu_2"
                                                    class="form-control form-control-sm text-center" step="0.01"
                                                    value="{{ old('suhu_produk.suhu_2', $suhuData['suhu_2'] ?? '') }}"
                                                    min="0">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <input type="number" name="suhu_produk[suhu_3]" id="suhu_3"
                                                    class="form-control form-control-sm text-center" step="0.01"
                                                    value="{{ old('suhu_produk.suhu_3', $suhuData['suhu_3'] ?? '') }}"
                                                    min="0">
                                            </td>
                                        </tr>
                                    </tbody>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input type="number" name="kondisi_produk[basah_air_ujung]"
                                                    ...
                                                    value="{{ old('kondisi_produk.basah_air_ujung', $kondisiData['basah_air_ujung'] ?? '') }}">
                                            </td>
                                            <td><input type="number" name="kondisi_produk[kering_air_ujung]"
                                                    ...
                                                    value="{{ old('kondisi_produk.kering_air_ujung', $kondisiData['kering_air_ujung'] ?? '') }}"
                                                    readonly></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><input type="number" name="kondisi_produk[basah_air_seal]"
                                                    ...
                                                    value="{{ old('kondisi_produk.basah_air_seal', $kondisiData['basah_air_seal'] ?? '') }}">
                                            </td>
                                            <td><input type="number" name="kondisi_produk[kering_air_seal]"
                                                    ...
                                                    value="{{ old('kondisi_produk.kering_air_seal', $kondisiData['kering_air_seal'] ?? '') }}"
                                                    readonly></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><input type="number" name="kondisi_produk[basah_air_total]"
                                                    ...
                                                    value="{{ old('kondisi_produk.basah_air_total', $kondisiData['basah_air_total'] ?? '') }}"
                                                    readonly></td>
                                            <td><input type="number" name="kondisi_produk[kering_air_total]"
                                                    ...
                                                    value="{{ old('kondisi_produk.kering_air_total', $kondisiData['kering_air_total'] ?? '') }}"
                                                    readonly></td>
                                        </tr>
                                    </tbody>
                                </table>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input type="number" name="kondisi_produk[basah_minyak_ujung]"
                                                    ...
                                                    class="form-control form-control-sm text-center"
                                                    value="{{ old('kondisi_produk.basah_minyak_ujung', $kondisiData['basah_minyak_ujung'] ?? '') }}">
                                            </td>
                                            <td><input type="number" name="kondisi_produk[kering_minyak_ujung]"
                                                    id="kering_minyak_ujung"
                                                    class="form-control form-control-sm text-center"
                                                    value="{{ old('kondisi_produk.kering_minyak_ujung', $kondisiData['kering_minyak_ujung'] ?? '') }}"
                                                    readonly></td>
                                        </tr>
                                        <tr>
                                            <td class="text-start">Seal</td>
                                            <td><input type="number" name="kondisi_produk[basah_minyak_seal]"
                                                    ...
                                                    class="form-control form-control-sm text-center"
                                                    value="{{ old('kondisi_produk.basah_minyak_seal', $kondisiData['basah_minyak_seal'] ?? '') }}">
                                            </td>
                                            <td><input type="number" name="kondisi_produk[kering_minyak_seal]"
                                                    id="kering_minyak_seal"
                                                    class="form-control form-control-sm text-center"
                                                    value="{{ old('kondisi_produk.kering_minyak_seal', $kondisiData['kering_minyak_seal'] ?? '') }}"
                                                    readonly></td>
                                        </tr>
                                        <tr>
                                            <td class="text-start">Total</td>
                                            <td><input type="number" name="kondisi_produk[basah_minyak_total]"
                                                    ...
                                                    class="form-control form-control-sm text-center"
                                                    value="{{ old('kondisi_produk.basah_minyak_total', $kondisiData['basah_minyak_total'] ?? '') }}"
                                                    readonly></td>
                                            <td><input type="number" name="kondisi_produk[kering_minyak_total]"
                                                    id="kering_minyak_total"
                                                    class="form-control form-control-sm text-center"
                                                    value="{{ old('kondisi_produk.kering_minyak_total', $kondisiData['kering_minyak_total'] ?? '') }}"
                                                    readonly></td>
                                        </tr>
                                    </tbody>
                                </table>
                                        ...
                                        @for ($i = 1; $i <= 3; $i++)
                                            <tr>
                                                <td><input type="number" name="berat_produk[pcs_{{ $i }}]"
                                                        id="pcs_{{ $i }}"
                                                        class="form-control form-control-sm text-center" step="0.01"
                                                        value="{{ old("berat_produk.pcs_$i", $beratData["pcs_$i"] ?? '') }}">
                                                </td>
                                                <td><input type="number" name="berat_produk[toples_{{ $i }}]"
                                                        id="toples_{{ $i }}"
                                                        class="form-control form-control-sm text-center" step="0.01"
                                                        value="{{ old("berat_produk.toples_$i", $beratData["toples_$i"] ?? '') }}">
                                                </td>
                                            </tr>
                                        @endfor
                                    </tbody>
