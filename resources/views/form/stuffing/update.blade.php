                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                @if($stuffing->kode_produksi)
                                    {{-- TAMPILKAN TEKS BATCH DARI RELASI AGAR TIDAK MUNCUL UUID --}}
                                    <input type="text" class="form-control" value="{{ $stuffing->mincing->kode_produksi ?? '-' }}" readonly>
                                    {{-- VALUE YANG DIKIRIM KE SERVER TETAP UUID --}}
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <input type="date" name="exp_date" id="exp_date" class="form-control @error('exp_date') is-invalid @enderror" value="{{ old('exp_date', $stuffing->exp_date) }}" {{ $stuffing->exp_date ? 'readonly' : '' }}>
