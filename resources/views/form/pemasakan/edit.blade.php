                                ...
                                <tbody>
                                    @foreach([
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" name="cooking[{{ $item['field'] }}]"
...
$(document).ready(function() {
    ...
    function renderRejectTable() {
        ...
        $('.kode_produksi').each(function(index) {
            ...
            if (value) {
                ...
                let rejectVal = currentRejects[index] ?? '';
    ...
    function hitungTotalTray() {
        ...
        if (total === 0) {
            ...
            summary.html(`<span class="text-danger">Total: ${total} tray (MELEBIHI standar 28!)</span>`);
        } else {
            summary.html(`<span class="text-success">Total: ${total} tray (Maks: 28)</span>`);
        }
    }
