...
@section('content')
    <div class="container-fluid py-0">
        ...
        <form id="filterForm" method="GET" action="{{ route('pemasakan_rte.index') }}"
            ...
            document.addEventListener('DOMContentLoaded', () => {
                ...
                if (exportBtn) {
                    exportBtn.addEventListener('click', () => {
                        ...
                        const exportUrl = "{{ route('pemasakan_rte.exportPdf') }}?" + new URLSearchParams(
                            formData).toString();
                                ...
                                <tr>
                                                    ...
                                                    if (is_array($val)) {
                                                        return collect($val)
                                                            ->map(
                                                                fn(
                                                                    $v,
                                                                ) => "<span class='badge bg-light text-dark border border-secondary me-1 mb-1'>$v</span>",
                                                            )
                                                            ->implode('');
                                                    }
                                                    return e($val ?? '-');
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            @foreach ($sections as $title => $rows)
                                                                <h6 class="fw-bold text-primary mt-3">{{ $title }}
                                                                </h6>
                                                                <div class="table-responsive">
                                                                    <table
                                                                        class="table table-sm table-bordered mb-3 align-middle text-start">
                                                                        <tbody>
                                    ...
                                    <td class="text-center align-middle">
                                        ...
                                        @can('can access edit button')
                                            <a href="{{ route('pemasakan_rte.edit.form', $dep->uuid) }}"
                                                class="btn btn-warning btn-sm me-1">
                                                <i class="bi bi-pencil-square"></i> Edit
                                            </a>
                                        @endcan
                                        @can('can access update button')
                                            <a href="{{ route('pemasakan_rte.update.form', $dep->uuid) }}"
                                                class="btn btn-info btn-sm me-1">
                                                <i class="bi bi-pencil"></i> Update
                                            </a>
                                        @endcan
                                        @can('can access delete button')
                                            <form action="{{ route('pemasakan_rte.destroy', $dep->uuid) }}" method="POST"
                                                class="d-inline">
                                                @csrf
                                                @method('DELETE')
                                        ...
                                        <div class="modal fade" id="verifyModal{{ $dep->uuid }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered modal-md">
                                                <form
                                                    action="{{ route('pemasakan_rte.verification.update', $dep->uuid) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PUT')
