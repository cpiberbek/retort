            ...
            <div class="row align-items-end">
                ...
                <div class="col-lg-3 col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <select name="jenis_kemasan" id="filter_jenis_kemasan"
                            class="form-select form-control border-start-0">
                            <option value="">Semua Jenis Kemasan</option>
                            <option value="Pouch" {{ request('jenis_kemasan') == 'Pouch' ? 'selected' : '' }}>Pouch
                            </option>
                            <option value="Toples" {{ request('jenis_kemasan') == 'Toples' ? 'selected' : '' }}>Toples
                            </option>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        Silakan pilih <b>Tanggal</b> & <b>Kode Batch</b> yang spesifik di bagian filter terlebih dahulu
                        sebelum melakukan export.
                    </div>
                        ...
                        <tbody>
                            ...
                            @forelse ($data as $dep)
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        {{ Str::isUuid($dep->kode_produksi) ? $dep->mincing->kode_produksi ?? '-' : $dep->kode_produksi }}
                                    </td>
                                    <td class="text-center align-middle">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header bg-danger text-white">
                                                            <h5 class="modal-title"
                                                                id="revisionModalLabel{{ $dep->uuid }}">Detail
                                                                Revisi</h5>
                                    ...
                                    <td class="text-center align-middle">
                                        ...
                                        <div class="modal fade" id="verifyModal{{ $dep->uuid }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered modal-md">
                                                <form
                                                    action="{{ route('release_packing.verification.update', $dep->uuid) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PUT')
