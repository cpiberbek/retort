...
@section('content')
        ...
        <div class="card shadow-sm border-0" style="border-radius: 12px;">
            ...
            <div class="card-header bg-white border-0 py-3 d-flex justify-content-between align-items-center"
                ...
                <h4 class="mb-0 fw-bold text-dark">
                    <i class="bi bi-box-seam me-2" style="color: #d32f2f;"></i>

                    List Premix
                </h4>

                <a href="{{ route('premix.create') }}" class="btn btn-sm btn-dark shadow-sm px-3 py-2 btn-tambah"
                ...
                <form method="GET" class="mb-4 d-flex justify-content-end">
                    ...
                    <div class="input-group input-group-sm shadow-sm custom-search-group">
                        ...
                        <input type="text" name="search" value="{{ request('search') }}"
                            class="form-control border-0 bg-light ps-3" placeholder="Cari nama premix...">
                ...
                <table class="table custom-table align-middle">
                    ...
                    <thead>
                        <tr class="text-center text-muted"
                            ...
                            <th>Kode Internal</th>
                            <th class="text-start">Nama Premix</th>
                            ...
                            <tr class="text-center">
                                ...
                                <td class="align-middle">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        ...
                                        {{-- Edit --}}
                                        <a href="{{ route('premix.edit', $item->uuid) }}"
                                            class="btn btn-outline-warning btn-sm action-btn mr-2" title="Edit">
                                        ...
                                        {{-- Delete --}}
                                        <form action="{{ route('premix.destroy', $item->uuid) }}" method="POST"
                                            class="m-0 p-0">
                                            ...
                                            <button type="submit"
                                                class="btn btn-outline-danger btn-sm action-btn btn-delete" title="Hapus">
            ...
            deleteButtons.forEach(button => {
                ...
                button.addEventListener('click', function(e) {
                    ...
                    Swal.fire({
                        ...
                        text: "Data premix ini tidak dapat dikembalikan!",
                        icon: 'warning',
    ...
    <style>
        ...
        .btn-tambah:hover {
            ...
            box-shadow: 0 4px 10px rgba(33, 37, 41, 0.3) !important;
        }
