    ...
    <div class="container-fluid py-0">
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <form id="filterForm" method="GET" action="{{ route('chamber.index') }}"
                    ...
                    <div class="row w-100">
                        ...
                        <div class="col-md-2 align-self-end">
                            ...
                            <a href="{{ route('chamber.index') }}" class="btn btn-primary mb-2"><i
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                Silakan pilih <b>Bulan</b> yang spesifik di bagian filter terlebih dahulu sebelum melakukan
                                export.
                            </div>
                    ...
                    document.addEventListener('DOMContentLoaded', () => {
                        ...
                        if (exportPdfBtn) {
                            exportPdfBtn.addEventListener('click', () => {
                                ...
                                const exportUrl = "{{ route('chamber.exportPdf') }}?" + new URLSearchParams(formData)
                                    .toString();
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                                ...
                                <tr>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-header bg-primary text-white">
                                                            <h5 class="modal-title"
                                                                ...
                                                                <i class="bi bi-list-task me-2"></i> Detail Verifikasi
                                                                Timer Chamber
                                                            </h5>
                                                        ...
                                                        <div class="modal-body text-start">
                                                            <div class="table-responsive">
                                                                <table
                                                                    class="table table-bordered table-striped table-sm text-center align-middle mb-3"
                                                                    style="font-size: 0.8rem;">
                                                                    <thead class="table-light">
                                                                        <tr class="table-secondary">
                                                                            <th rowspan="2" colspan="2"
                                                                                class="align-middle">RENTANG UKUR</th>
                                                                            @foreach ($chambers as $index => $row)
                                                                                <th colspan="6" class="fw-bold">No.
                                                                                    Chamber {{ $index + 1 }}</th>
                                                                            @endforeach
                                                                        </tr>
                                                                        <tr>
                                                                    ...
                                                                    <tbody>
                                                                        @foreach ($rentang_menit as $rentang)
                                                                            <tr>
                                                                                <td class="fw-bold">{{ $rentang }}
                                                                                </td>
                                                                                <td>00</td>
                                                                                @foreach ($chambers as $index => $row)
                                                                                    <td>{{ $row['plc_menit_' . $rentang] ?? '-' }}
                                                                                    </td>
                                                                                    <td>{{ $row['plc_detik_' . $rentang] ?? '-' }}
                                                                                    </td>
                                                                                    <td>{{ $row['stopwatch_menit_' . $rentang] ?? '-' }}
                                                                                    </td>
                                                                                    <td>{{ $row['stopwatch_detik_' . $rentang] ?? '-' }}
                                                                                    </td>
                                                                                    <td colspan="2"
                                    ...
                                    <td class="text-center align-middle">
                                        ...
                                        @can('can access edit button')
                                            <a href="{{ route('chamber.edit.form', $dep->uuid) }}"
                                                class="btn btn-warning btn-sm me-1 mb-1">
                                                <i class="bi bi-pencil-square"></i> Edit
                                            </a>
                                        @endcan
                                        @can('can access update button')
                                            <a href="{{ route('chamber.update.form', $dep->uuid) }}"
                                        ...
                                        @can('can access delete button')
                                            <form action="{{ route('chamber.destroy', $dep->uuid) }}" method="POST"
                                                class="d-inline">
                                                @csrf @method('DELETE')
                                        ...
                                        <div class="modal fade" id="verifyModal{{ $dep->uuid }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered modal-md">
                                                <form action="{{ route('chamber.verification.update', $dep->uuid) }}"
                                                    method="POST">
                                                    @csrf @method('PUT')
                            ...
                            @empty
                                <tr>
                                    <td colspan="8" class="text-center">Belum ada data verifikasi timer chamber.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
