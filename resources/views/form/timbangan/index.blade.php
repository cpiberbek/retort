...
@section('content')
    <div class="container-fluid py-0">
        ...
        <div class="d-sm-flex justify-content-between align-items-center mb-4">
            ...
            <div class="btn-group" role="group">
                ...
                @can('can access export')
                    <a href="{{ route('timbangan.exportPdf', ['date' => request('date'), 'shift' => request('shift')]) }}"
        ...
        <form id="filterForm" method="GET" action="{{ route('timbangan.index') }}"
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        ...
                                        @can('can access edit button')
                                            <a href="{{ route('timbangan.edit.form', $dep->uuid) }}"
                                                class="btn btn-warning btn-sm me-1 mb-1">
                                                <i class="bi bi-pencil-square"></i> Edit Data
                                            </a>
                                        @endcan
                                        @can('can access update button')
                                            <a href="{{ route('timbangan.update.form', $dep->uuid) }}"
                                                class="btn btn-info btn-sm me-1 mb-1">
                                                <i class="bi bi-pencil"></i> Update
                                            </a>
                                        @endcan
                                        @can('can access delete button')
                                            <form action="{{ route('timbangan.destroy', $dep->uuid) }}" method="POST"
                                                class="d-inline">
                                                @csrf
                                                @method('DELETE')
                                        ...
                                        <div class="modal fade" id="verifyModal{{ $dep->uuid }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered modal-md">
                                                <form action="{{ route('timbangan.verification.update', $dep->uuid) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PUT')
