    ...
    <div class="container-fluid py-0">
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <form id="filterForm" method="GET" action="{{ route('traceability.index') }}"
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        ...
                                        @if (!empty($traceability))
                                            <a href="#" data-bs-toggle="modal"
                                                data-bs-target="#traceModal{{ $dep->uuid }}"
                                                            ...
                                                            <div class="table-responsive">
                                                                <table
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        @endforeach
                                                                        <tr>
                                                                            <td colspan="4">Total Waktu Traceability
                                                                            </td>
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Dari hasil Traceability yang telah
                                                            dilakukan, dapat disimpulkan:</h5>
                                    ...
                                    <td class="text-center align-middle">
                                        ...
                                        @can('can access edit button')
                                            <a href="{{ route('traceability.edit', $dep->uuid) }}"
                                                class="btn btn-warning btn-sm">
                                                <i class="bi bi-pencil"></i> Edit
                                            </a>
                                        @endcan
                                        @can('can access delete button')
                                            <form action="{{ route('traceability.destroy', $dep->uuid) }}" method="POST"
                                                class="d-inline">
                                                @csrf
                                                @method('DELETE')
                                        ...
                                        <div class="modal fade" id="verifyModal{{ $dep->uuid }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered modal-md">
                                                <form action="{{ route('traceability.updateVerification', $dep->uuid) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PUT')
                ...
                {{ $dep->catatan_spv }}</textarea>
                                        ...
                                        <div class="modal fade" id="verifyManagerModal{{ $dep->uuid }}"
                                            ...
                                            aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered modal-md">
                                                <form action="{{ route('traceability.updateApproval', $dep->uuid) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <input type="hidden" name="page"
