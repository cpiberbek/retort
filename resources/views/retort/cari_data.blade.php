...
<div class="container-fluid">
    ...
    @php
        ...
        //**!! Informasi: table yang di-comment merupakan table yang bukan bagian dari form yang sudah ada maupun master data**!!
        $tables = [
    ...
    @foreach ($tables as $title => $data)
        ...
        @switch($title)
            ...
            @case('PEMUSNAHAN')
                <div class="card shadow-sm mb-4">
                    <div class="card-header bg-danger text-white d-flex justify-content-between align-items-center">
                        <span class="fw-bold">DATA PEMUSNAHAN BARANG / VARIAN</span>
                        <span class="badge bg-light text-dark">{{ $data->count() }}</span>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    @forelse ($data as $dep)
                                        <tr>
                                            ...
                                            <td>
                                                {{ $dep->batch->kode_produksi ?? $dep->kode_produksi ?? '-' }}
                                            </td>
            ...
            @case('RELEASE PACKING RTE')
                <div class="card shadow-sm mb-4">
                    <div class="card-header bg-danger text-white d-flex justify-content-between align-items-center">
                        <span class="fw-bold">DATA RELEASE PACKING RTE</span>
                        <span class="badge bg-light text-dark">{{ $data->count() }}</span>
                    </div>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="10" class="text-center py-4 text-muted">
                                                Belum ada data release packing RTE.
                                            </td>
                                        </tr>
                                    @endforelse
                                </tbody>
